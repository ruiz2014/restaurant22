        ...
        <div class="col-3">
            <div class="card mb-3 rounded-pill" style="max-width: 540px;">
                <div class="row g-0">
                    ...
                    <div class="col-md-9">
                        <div class="card-body">
                            <h5 class="card-title mb-0 fw-normal">Martin Ruiz Espil</h5>
                            <p class="card-text"><small class="text-body-secondary">Administrador</small></p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var xValues = ["Ticket", "Factura", "Boleta"];
