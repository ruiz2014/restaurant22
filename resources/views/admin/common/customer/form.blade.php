...
<div class="row padding-1 p-1">
    ...
    <div class="col-md-6">
        <div class="form-group mb-4 mb20">
            ...
            <select name="tipo_doc" id="tipo_doc" class="form-control-2 line vld draw">
                <option value="1" {{$customer?->tipo_doc== 1 ? 'selected' : ''}}>DNI</option>
                <option value="6" {{$customer?->tipo_doc == 6 ? 'selected' : ''}}>RUC</option>
            </select>
