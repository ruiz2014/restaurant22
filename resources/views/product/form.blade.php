<div class="row padding-1 p-1">
    ...
    <div class="col-md-6">
        <div class="form-group mb-4 mb20">
            ...
            {!! $errors->first('description', '<div class="invalid-feedback d-block" role="alert"><strong>:message</strong></div>') !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-4 mb20">
            ...
            {!! $errors->first('price', '<div class="invalid-feedback d-block" role="alert"><strong>:message</strong></div>') !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-4 mb20">
            ...
            <input type="text" name="stock" class="form-control-2 @error('stock') is-invalid @enderror" value="{{ old('stock', $product?->stock) }}" id="stock" placeholder="Stock">
            {!! $errors->first('stock', '<div class="invalid-feedback d-block" role="alert"><strong>:message</strong></div>') !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-4 mb20">
            <label for="provider_id" class="form-label-2">{{ __('Provider Id') }}</label>
            <select name="provider_id" id="" class="form-control-2 line vld draw">
                @foreach($providers as $keyP => $valueP)
                <option value="{{ $keyP  }}" {{$product?->provider_id == $keyP  ? 'selected' : ''}}>{{  $valueP }}</option>
                @endforeach
            </select>
